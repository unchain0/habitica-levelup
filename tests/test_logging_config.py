...
class TestSetupLogging:
    def test_setup_logging_removes_default_handler(self):
        with patch("src.delivery.logging.logger") as mock_logger:
            setup_logging("INFO")
            mock_logger.remove.assert_called_once()

    def test_setup_logging_adds_stderr_handler(self):
        with patch("src.delivery.logging.logger") as mock_logger:
            with patch("src.delivery.logging.sys.stderr"):
                setup_logging("INFO")
    ...
    def test_setup_logging_creates_log_directory(self):
        with patch("src.delivery.logging.logger"), patch("src.delivery.logging.sys.stderr"):
